...
export const NovaMarcaCreateForm = () => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      const marcasId = response.data.id;
      toast.success(response.data.message || "Marca criada com sucesso");
      router.push(`/marcas/${marcasId}`);
    } catch (error) {
