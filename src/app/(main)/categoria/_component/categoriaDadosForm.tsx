...
interface CategoriaDadosFormProps {
  dadosIniciais: {
    title: string;
    description: string;
    imageUrl?: string;
...
export const CategoriaDadosForm = ({ dadosIniciais, categoriaId }: CategoriaDadosFormProps) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      const response = await axios.patch(`/api/categoria/${categoriaId}`, values);
